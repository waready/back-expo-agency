         ...
         jQuery(document).ready(function() {
            dt = jQuery("#students-table").DataTable({
                ...
                rowCallback:function(row, data,index){
                    $('td:eq(2)',row).html('<a class="editar-usuario" href="#"> <i class="fas fa-pencil-alt big-icon text-primary" aria-hidden="true"></i></a>  <a class="eliminar-usuario" href="#"> <i class="fas fa-trash big-icon text-danger" aria-hidden="true"></i></a>')
                }
